...
function summarizeScoutTarget(target) {
  ...
  return {
    id: compactId,
    score: target.score,
    exposureValue: target.exposureValue,
    exposureScore: target.exposureScore,
    distanceScore: target.distanceScore,
    totalTravelDistance: target.totalTravelDistance,
    checkpointStaleness: target.checkpointStaleness,
    averageMultiplier: target.averageMultiplier,
