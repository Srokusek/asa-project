...
export function parseMap(json) {
  ...
  const state = {
    ...
    missionSpecs: Array.isArray(input.missionSpecs) ? input.missionSpecs.map((spec) => ({ ...spec })) : [],
    deliveryRules: input.deliveryRules && typeof input.deliveryRules === "object" ? { ...input.deliveryRules } : {},
    deliveryDecision: input.deliveryDecision && typeof input.deliveryDecision === "object" ? { ...input.deliveryDecision } : null,
    ...
    stackRules: Array.isArray(input.stackRules) ? input.stackRules.map((rule) => ({ ...rule })) : [],
    teamState: input.teamState && typeof input.teamState === "object" ? { ...input.teamState } : {},
    zoneMemory: input.zoneMemory && typeof input.zoneMemory === "object" ? { ...input.zoneMemory } : null,
